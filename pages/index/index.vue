<template>
	...
	<!-- <view v-if="tabberPageLoadFlag[3]" :style="{display: currentIndex === 3 ? '' : 'none'}">
		...
		<view v-if="tabberPageLoadFlag[5]" :style="{display: currentIndex === 5 ? '' : 'none'}">
			<scroll-view class="custom-tabbar-page" scroll-y enable-back-to-top @scrolltolower="tabbarPageScrollLower">
				<vip ref="vip"></vip>
			</scroll-view>
		</view>
		<view v-if="tabberPageLoadFlag[6]" :style="{display: currentIndex === 6 ? '' : 'none'}">
			<scroll-view class="custom-tabbar-page" scroll-y enable-back-to-top @scrolltolower="tabbarPageScrollLower">
				<templatePage ref="template"></templatePage>
			</scroll-view>
		</view>
		<view v-if="tabberPageLoadFlag[7]" :style="{display: currentIndex === 7 ? '' : 'none'}">
			<scroll-view class="custom-tabbar-page" scroll-y enable-back-to-top @scrolltolower="tabbarPageScrollLower">
...
<script>
	...
	import Index from "../pet/index.vue"
	import Pet from "../pet/pet.vue"
	import log from "../pet/log.vue"
